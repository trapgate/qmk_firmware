...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   TD(0),
        ...
        // right hand
             ...
             TD(1),       KC_N,   KC_M,  KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_TILD,TG(GAME),
          EPRM,KC_TRNS,KC_TRNS,KC_LEFT,KC_RIGHT,
                                       RGB_MOD,KC_TRNS,
                                               KC_TRNS,
...
[GAME] = LAYOUT_ergodox(  // layer 3 : game layer
        ...
        KC_BSPC,        KC_A,         KC_S,   KC_D,   KC_F,   KC_G,
        KC_LSFT,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   TO(BASE),
